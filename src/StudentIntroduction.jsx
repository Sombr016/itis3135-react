export default function StudentIntroduction({ studentData, displayName, displayMascot, displayImage, displayPersonalStatement, displayBackgrounds, displayClasses, displayExtraInformation, displayQuote, displayLinks }) {
    ...
    return (
        <article>
            ...
            <p>{displayPersonalStatement && studentData.personalStatement}</p>
